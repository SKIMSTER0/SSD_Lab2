...
namespace L01SampleAuth.Data
{
    public static class DbInitializer
    {
        ...
        private static async Task<int> SeedUsers(UserManager<ApplicationUser> userManager)
        {
            ...
            string defaultPassword = Environment.GetEnvironmentVariable("defaultPassword");
            ...
            result = await userManager.CreateAsync(memberUser, defaultPassword);
            if (!result.Succeeded)
                return 3;  // should log an error message here
